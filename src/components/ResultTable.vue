...
<template>
  ...
  >
    ...
    >
      <div v-if="table" class="flex flex-col h-full">
        <div class="overflow-auto flex-1">
          <table class="w-full border-collapse">
            <thead
              class="sticky top-0 bg-zinc-100/95 dark:bg-zinc-900/95 border-b border-zinc-300/60 dark:border-zinc-800/40 z-10 backdrop-blur-sm"
            >
      ...
      <pre
        v-else
        class="text-xs font-mono text-zinc-700 dark:text-zinc-300 whitespace-pre-wrap p-4"
